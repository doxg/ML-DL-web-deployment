...
class CatDogModel:
    def __init__(self):
        self.model = Model(ResnetBlock, train_on=False)
        best_weights = 'pretrained_models/best_weights_CatDog.pth.tar'
        checkpoint = t.load(best_weights)
        self.model.load_state_dict(checkpoint['state_dict'])
        self.model.eval()


binary_clf = CatDogModel()
